...
$(document).ready(function () {
    ...
    const dt = $('#ScoreBoard').DataTable({
        ...
        columns: [
            ...
            {
                data: null, autowidth: true,
                defaultContent: '<span style="width:150px;font-weight:bolder" disabled class="OverallPlace"></span>', searchable: false,
            ...
            $(document).ready(function () {
                $(".FinalScore")
                    ...
                    .forEach((v, i) => {
                        ...
                        $('.FinalScore').filter(function () { return test = $(this).val() == v; }).parent().next('td').children('span').html(i + 1);
